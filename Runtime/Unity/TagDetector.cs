...
public sealed class TagDetector : System.IDisposable
{
    ...
    public IEnumerable<TagInfo> DetectedTagInfos => _detectedTagInfos;
    ...
    public void ProcessImageAndPose
    ...
    List<TagInfo> _detectedTagInfos = new List<TagInfo>();
    ...
    // Detect the tags, but don't estimate the pose
    void RunDetector()
    {
        _profileData = null;
